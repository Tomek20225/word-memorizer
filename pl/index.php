...
<html lang="pl">
	...
	<body>
		...
		<nav class="navbar navbar-light bg-light">
		  	...
		  	<a class="navbar-brand" href="#">by Tomasz Kapcia</a>
		</nav>
		...
		<div class="container">
			...
			<div class="main">
				...
				<div>
					<div class="roundedInput">
						<input type="number" id="amount" placeholder="Liczba słów" min=1>

						<button class="btn btn-success" onclick="pickWords();">Losuj</button>
					</div>					
			...
			<div id="nextStep" class="inactive">
				<button class="btn btn-outline-info" onclick="pickRandom();">Losuj słowo do sprawdzenia!</button>
				...
				<div id="checkContainer" class="inactive">
					<div id="checkerBox" class="active">
						...
						<button class="btn btn-outline-success" onclick="checkWord();">Sprawdź!</button>
					</div>
		...
		<div id="loadingOverlay" class="active">
			<div>
				<h1 class="display-3">Ładowanie...</h1>
				<br>
